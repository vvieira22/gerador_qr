...
class JanelaOndeSalvarQR():
    def tela_salvar_qr(self, janela_mae, imagem, salvar_qr_no_banco, salvar_qr_como_imagem):
        ...
        self.widgets_frame2(imagem, salvar_qr_no_banco, salvar_qr_como_imagem)

        self._janela_salvar_qr.transient(janela_mae)
        
    def widgets_frame2(self, imagem, salvar_qr_no_banco, salvar_qr_como_imagem):
        ...
        compound="right", bg = "#34dfc9", fg="black", command = salvar_qr_no_banco)
