...
class TelaBancoDeQrs():
    ...
    def widgets_tela_qrs_do_banco(self):
        ...
        self._lb_codigo.place(relx = 0.9, rely = 0.1, relwidth = 0.07, relheight = 0.1, anchor = "center")

        self._entry_codigo = Label(self._janela_banco_qr, font=("verdana", 12))
        self._entry_codigo.place(relx = 0.9, rely = 0.20, relwidth = 0.05, relheight = 0.06, anchor = "center")

        #Conteúdo
        self._lb_conteudo = Label(self._janela_banco_qr, text = "Conteúdo", bg = '#dfe3ee', fg = '#107db2')
        self._lb_conteudo.place(relx = 0.9, rely = 0.30, relwidth = 0.07, relheight = 0.1, anchor = "center")

        self._entry_conteudo = Entry(self._janela_banco_qr, font=("verdana", 10))
        self._entry_conteudo.insert(-1, '')
        self._entry_conteudo.place(relx = 0.91, rely = 0.40, relwidth = 0.18, relheight = 0.06, anchor = "center")

        #Hora
        self._lb_data = Label(self._janela_banco_qr, text = "Data", bg = '#dfe3ee', fg = '#107db2')
        self._lb_data.place(relx = 0.9, rely = 0.50, relwidth = 0.07, relheight = 0.1, anchor = "center")

        self._entry_data = Entry(self._janela_banco_qr, font=("verdana", 10))
        self._entry_data.insert(-1, '')
        self._entry_data.place(relx = 0.91, rely = 0.60, relwidth = 0.18, relheight = 0.06, anchor = "center")
        ...
        self._botao_excluir.place(relx = 0.91, rely = 0.82, relwidth = 0.18, relheight = 0.1, anchor = "center")
